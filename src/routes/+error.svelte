...
<div class="flex min-h-screen items-center justify-center bg-white px-6">
	<div class="w-full max-w-3xl py-24 text-center">
		<div class="inline-flex items-baseline gap-6">
			...
			<div class="text-left">
				<p class="mb-2 text-2xl font-semibold sm:text-3xl">Page not found</p>
				<p class="mb-6 max-w-md text-gray-600">
					The page you're looking for doesn't exist or has been moved. Try returning home or opening a file from the
					editor.
				</p>
